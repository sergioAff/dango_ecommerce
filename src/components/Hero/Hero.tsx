...
export const Hero = () => {
  ...
  const buttonRefs = useRef<(HTMLButtonElement | null)[]>([]); // Referencias dinámicas para cada botón
  ...
  useEffect(() => {
    ...
    window.addEventListener("resize", calculateInitialDistance);
  ...
  return (
    <>
      ...
      >
          ...
          >
            <div className="pt-[23px] pb-[105px] md:py-[60px] flex flex-col md:flex-row-reverse md:justify-evenly items-center md:px-[3dvw]">
              <Image
                ...
                width={2000}
                height={2000}
                className="rounded-xl w-[280px] h-[320px] lg:min-w-[486px] lg:min-h-[600px] object-cover"
              />
              <div className="flex flex-col pt-[33px] md:pt-0 gap-10 md:pb-14 lg:pb-32 xl:max-w-[800px]">
                <div className="px-12 md:px-0 md:flex flex-col gap-5">
                  <h1 className="text-primary text-[37px] md:text-[60px] text-center md:text-start leading-10 md:leading-[61px] md:pr-[20%] xl:pr-[40%]">
                    {item.title}
                  </h1>
                ...
                <div className="flex flex-col md:flex-row items-center md:gap-4">
                  <button
                    ...
                    className="rounded-[10px] w-[170px] md:w-[206px] h-[57px] items-center flex justify-between md:justify-evenly bg-primary text-white tracking-wide leading-4 text-sm px-6 md:font-semibold"
                  >
                    SHOP NOW
        ...
        <ScrollButtons distance={initialDistance ?? 0} />
      </Swiper>
    </>
  );
};
